...
import { isGradient } from '/js/maptalks/core/util/style.js';
import Point from '/js/maptalks/geo/Point.js';
import { getFont, getAlignPoint } from '/js/maptalks/core/util/strings.js';
...
const Canvas = {
    ...
    createCanvas(width, height, canvasClass) {
        let canvas = new canvasClass(width, height);
        return canvas;
    },
